...
<div class="container my-5" id="portfolio">
    <div class="container px-lg-5">
        <div class="wow fadeInUp" data-wow-delay="0.1s">
            <h1 class="text-center serv-title mb-5">Our Portofolio</h1>
        </div>
        <div class="row mt-n2 wow fadeInUp" data-wow-delay="0.3s">
            <div class="col-12 text-center">
                <ul class="list-inline mb-5" id="portfolio-flters">
                    <li class="mx-2 active" data-filter=".first">Web Development</li>
        ...
        <div class="row g-4 portfolio-container">
            <div class="col-lg-4 col-md-6 portfolio-item first wow fadeInUp" data-wow-delay="0.1s">
                <div class="rounded overflow-hidden">
                    ...
                    <div class="bg-light p-4">
                        <p class="text-primary fw-bold fs-5 mb-2">Company Profile</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 portfolio-item second wow fadeInUp" data-wow-delay="0.3s">
                <div class="rounded overflow-hidden">
                    ...
                    <div class="bg-light p-4">
                        <p class="text-primary fw-bold fs-5 mb-2">Structure Cabling System</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 portfolio-item second wow fadeInUp" data-wow-delay="0.3s">
                <div class="rounded overflow-hidden">
                    ...
                    <div class="bg-light p-4">
                        <p class="text-primary fw-bold fs-5 mb-2">CCTV Systems</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 portfolio-item first wow fadeInUp" data-wow-delay="0.5s">
                <div class="rounded overflow-hidden">
                    ...
                    <div class="bg-light p-4">
                        <p class="text-primary fw-bold fs-5 mb-2">Educational Platform</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 portfolio-item second wow fadeInUp" data-wow-delay="0.3s">
                <div class="rounded overflow-hidden">
                    ...
                    <div class="bg-light p-4">
                        <p class="text-primary fw-bold fs-5 mb-2">Telephone Systems</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 portfolio-item second wow fadeInUp" data-wow-delay="0.1s">
                <div class="rounded overflow-hidden">
                    ...
                    <div class="bg-light p-4">
                        <p class="text-primary fw-bold fs-5 mb-2">IPTV Systems</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 portfolio-item first wow fadeInUp" data-wow-delay="0.3s">
                <div class="rounded overflow-hidden">
                    ...
                    <div class="bg-light p-4">
                        <p class="text-primary fw-bold fs-5 mb-2">Engineering Insights</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 portfolio-item second wow fadeInUp" data-wow-delay="0.3s">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item second wow fadeInUp" data-wow-delay="0.3s">
                <div class="rounded overflow-hidden">
                    ...
                    <div class="bg-light p-4">
                        <p class="text-primary fw-bold fs-5 mb-2">IT Infrastructure Designing and Implementation</p>
                    </div>
                </div>
            </div>
        </div>
